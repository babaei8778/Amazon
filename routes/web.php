...
Route::namespace ('Market')->group(function () {
    ...
    Route::get('/add-rate/prodcut/{product:slug}', [MarketProductController::class, 'addRate'])->name('customer.market.add-rate');
...
Route::namespace ('Profile')->group(function () {
    ...
    Route::get('/my-commpares', [FavoriteController::class, 'index'])->name('customer.profile.my-commpares');
