<aside id="sidebar" class="sidebar col-md-3">
    ...
    <section class="content-wrapper bg-white p-3 rounded-2 mb-3">
        ...
        <section class="">
            <input class="sidebar-input-text" type="text" value="{{ request()->search }}" name="search" placeholder="جستجو بر اساس نام، برند ...">
        </section>
    </section>
    ...
    <section class="content-wrapper bg-white p-3 rounded-2 mb-3">
        ...
        <section class="sidebar-brand-wrapper">
            ...
            <section class="form-check sidebar-brand-item">
                <input class="form-check-input" name="brands[]" @if (request()->brands && in_array($brand->id, request()->brand))checked  
                @endif type="checkbox" value="{{ $brand->id }}" id="{{ $brand->id }}">
    ...
    <section class="content-wrapper bg-white p-3 rounded-2 mb-3">
        ...
        <section class="sidebar-price-range d-flex justify-content-between">
            <section class="p-1"><input type="text" placeholder="قیمت از ..." value="{{ request()->min_price }}"></section>
            <section class="p-1"><input type="text" placeholder="قیمت تا ..." value="{{ request()->max_price }}"></section>
        </section>
    </section>
    ...
    <section class="content-wrapper bg-white p-3 rounded-2 mb-3">
        ...
        <section class="sidebar-filter-btn d-grid gap-2 mt-2">
            <a href="{{ route('customer.products') }}" class="btn btn-outline-info border-3" type="button">حذف فیلتر</a>
        </section>
    </section>
    </form>
