...
<header class="header mb-4">
    ...
    <section class="top-header">
        <section class="container-xxl ">
            <section class="d-md-flex justify-content-between align-items-center py-3">
                <section class="d-flex justify-content-between align-items-center d-md-block">
                    ...
                    <a class="text-decoration-none logo-link " href="{{ route('customer.home') }}"><img src="customer-assets/images/logo/8.png" alt="logo"></a>
                    
                </section>
    
                <section class=" search-and-icons d-flex justify-content-between ">
                    ...
                    <section class="header-cart d-inline ps-3 border-start position-relative">
                        ...
                        <section class="header-cart-dropdown">
                            ...
                            <section class="header-cart-dropdown-footer border-top d-flex justify-content-between align-items-center p-2">
                                <section class=""><section>مبلغ قابل پرداخت</section><section></section></section>
        ...
        <section class="container-xxl ">
            <nav class="">
                <section class="d-none d-md-flex justify-content-md-start position-relative">
                    ...
                    <!-- <section class="border-start my-2 mx-1"></section>  changed to this: --> 
                    <section class="border-start my-3 mx-2"></section>
