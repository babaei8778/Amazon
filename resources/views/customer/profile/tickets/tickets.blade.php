                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="width-16-rem text-left">
                                            ...
                                            <a href="{{ route('customer.profile.my-tickets.change', $ticket->id) }}" class="btn btn-warning btn-sm"><i @if($ticket->status == 1) class="fa fa-check" @else class="fa fa-times" @endif></i></a>
                                        </td>
                                    </tr>
